 ...
 */
final class Version20190118091034 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE asset (id INT AUTO_INCREMENT NOT NULL, actor_id INT NOT NULL, availability_calendar_id INT DEFAULT NULL, descript VARCHAR(255) DEFAULT NULL, daily_rate INT DEFAULT NULL, nb_person INT DEFAULT NULL, size VARCHAR(255) DEFAULT NULL, floor VARCHAR(100) DEFAULT NULL, accomodation_type VARCHAR(255) NOT NULL, state VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, gps VARCHAR(255) DEFAULT NULL, INDEX IDX_2AF5A5C10DAF24A (actor_id), UNIQUE INDEX UNIQ_2AF5A5C66344A69 (availability_calendar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE availability_calendar (id INT AUTO_INCREMENT NOT NULL, bookable_date DATE NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `condition` (id INT AUTO_INCREMENT NOT NULL, payement VARCHAR(100) NOT NULL, arrival_time TIME DEFAULT NULL, departure_time TIME DEFAULT NULL, is_smoker_friendly TINYINT(1) DEFAULT NULL, has_parking TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE asset ADD CONSTRAINT FK_2AF5A5C66344A69 FOREIGN KEY (availability_calendar_id) REFERENCES availability_calendar (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE asset DROP FOREIGN KEY FK_2AF5A5C66344A69');
